            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-emerald-500/10 border border-emerald-500/20 rounded p-2 mb-2">
                  <p className="text-xs text-emerald-400 font-medium">Один URL для всех событий</p>
                  <p className="text-[10px] text-muted-foreground">Keitaro сам подставляет тип события (lead/sale/install) в параметр &#123;status&#125;. Наш сервер автоматически различает события.</p>
                </div>
                ...
                <div>
                  ...
                  <ol className="text-xs text-muted-foreground space-y-1 list-decimal list-inside">
                    ...
                    <li>Скопируйте Postback URL из карточки токена ниже</li>
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground space-y-0.5">
                    ...
                    <p><code className="text-orange-400">&#123;status&#125;</code> → тип события (lead, sale, install) - <span className="text-emerald-400">Keitaro подставляет автоматически!</span></p>
          ...
          <Card className="bg-blue-500/10 border-blue-500/20 p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-emerald-500/10 border border-emerald-500/20 rounded p-2 mb-2">
                  <p className="text-xs text-emerald-400 font-medium">Один URL для всех событий</p>
                  <p className="text-[10px] text-muted-foreground">Binom сам подставляет тип события (lead/sale/rebill) в параметр &#123;status&#125;. Наш сервер автоматически различает события.</p>
                </div>
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground space-y-0.5">
                    ...
                    <p><code className="text-blue-400">&#123;status&#125;</code> → тип события (lead, sale, rebill, approved) - <span className="text-emerald-400">Binom подставляет автоматически!</span></p>
