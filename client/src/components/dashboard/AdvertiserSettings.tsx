        ...
        <CardContent className="space-y-6">
          <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
            ...
            <p className="text-xs text-muted-foreground mt-2">
              По умолчанию используется бот <a href="https://t.me/primetrack_support_bot" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">@primetrack_support_bot</a> платформы. Если хотите использовать своего бота — укажите его токен.
            </p>
          </div>
