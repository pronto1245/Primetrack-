    ...
    <div className="space-y-6">
      <Card className="bg-blue-500/10 border-blue-500/30">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p><strong>1. Название бренда</strong> — отображается вместо названия платформы в партнёрском кабинете</p>
          <p><strong>2. Логотип</strong> — показывается в шапке дашборда и на странице входа (через кастомный домен)</p>
          <p><strong>3. Скрытие брендинга платформы</strong> — партнёры видят только ваш бренд без упоминания платформы</p>
          <p className="text-blue-400 pt-2">Для полного white-label подключите кастомный домен в разделе "Домены"</p>
        </CardContent>
      </Card>
