              ...
              {clicks.length === 0 ? (
                ...
                clicks.map((click: any) => (
                  <tr key={click.id} className="hover:bg-muted transition-colors">
                    ...
                    <td className="px-4 py-3 text-muted-foreground">{click.publisherShortId ? `${click.publisherShortId} - ${click.publisherName}` : '-'}</td>
                    <td className="px-4 py-3">
                ...
                conversions.map((conv: any) => {
                  ...
                  return (
                    <tr key={conv.id} className="hover:bg-muted transition-colors">
                      ...
                      <td className="px-4 py-3 text-muted-foreground">{conv.publisherShortId ? `${conv.publisherShortId} - ${conv.publisherName}` : '-'}</td>
